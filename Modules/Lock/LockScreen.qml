...
WlSessionLockSurface {
    ...
    color: "black" // Ensure background is black, not white
    ...
    RowLayout {
        ...
        ColumnLayout {
            ...
            Rectangle {
                ...
                color: root.colors.surface // Solid background
                radius: 28
                border.width: 1
                ...
                ColumnLayout {
                    ...
                    Rectangle { 
                        ...
                        color: root.colors.border; Layout.margins: 10
                    }
                    ...
                    RowLayout {
                        ...
                        Layout.alignment: Qt.AlignHCenter
                        ColumnLayout {
                             Text { text: "CPU"; color: root.colors.muted; font.pixelSize: 12 }
                             Text { 
                        ...
                        ColumnLayout {
                             Text { text: "RAM"; color: root.colors.muted; font.pixelSize: 12 }
                             Text { 
            ...
            Rectangle {
                    ...
                    Item {
                        ...
                        Image {
                            ...
                            layer.effect: OpacityMask {
                                maskSource: Rectangle { width: 64; height: 64; radius: 12 }
                            }
                        }
                ...
                // Removed whole-tile click to allow individual buttons
            }
        }

        // Center Column: Clock & Auth
        ColumnLayout {
            Layout.fillHeight: true
            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    Rectangle {
                        ...
                        radius: 22
                        color: Qt.rgba(0, 0, 0, 0.5) // Dark background
